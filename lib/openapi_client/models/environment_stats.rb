...
module OpenapiClient
  class EnvironmentStats
    ...
    attr_accessor :custom_branch_name

    attr_accessor :pdp_configs
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::EnvironmentStats` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::EnvironmentStats`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'custom_branch_name')
        self.custom_branch_name = attributes[:'custom_branch_name']
      end

      if attributes.key?(:'pdp_configs')
        if (value = attributes[:'pdp_configs']).is_a?(Array)
          self.pdp_configs = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @pdp_configs.nil?
        invalid_properties.push('invalid value for "pdp_configs", pdp_configs cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @pdp_configs.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          custom_branch_name == o.custom_branch_name &&
          pdp_configs == o.pdp_configs &&
          stats == o.stats
    end
    ...
    def hash
      [key, id, organization_id, project_id, created_at, updated_at, name, description, custom_branch_name, pdp_configs, stats].hash
    end
