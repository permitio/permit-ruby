...
module OpenapiClient
  class PolicyRepoRead
    ...
    attr_accessor :activate_when_validated
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PolicyRepoRead` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PolicyRepoRead`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'main_branch_name')
        self.main_branch_name = attributes[:'main_branch_name']
      else
      ...
      if attributes.key?(:'activate_when_validated')
        self.activate_when_validated = attributes[:'activate_when_validated']
      else
        self.activate_when_validated = false
      end
    end
    ...
    def valid?
      ...
      return false if @url !~ Regexp.new(/^(.+@)*([\w\d\.]+):(.*)?.git$/)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          key == o.key &&
          url == o.url &&
          main_branch_name == o.main_branch_name &&
          credentials == o.credentials &&
          activate_when_validated == o.activate_when_validated
    end
    ...
    def hash
      [id, status, key, url, main_branch_name, credentials, activate_when_validated].hash
    end
